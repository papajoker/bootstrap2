...
<html lang="en">
	<head>
		...
		<!-- CSS
		================================================== -->
		<link href="{{ asset('packages/papajoker/bootstrap2/css/bootstrap-2.3.2.min.css') }}" rel="stylesheet">
		<link href="{{ asset('packages/papajoker/bootstrap2/css/bootstrap-responsive-2.3.2.min.css') }}" rel="stylesheet">
		...
		<!-- Favicons
		================================================== -->
		<link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{ asset('packages/papajoker/bootstrap2/ico/apple-touch-icon-144-precomposed.png') }}">
		<link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{ asset('packages/papajoker/bootstrap2/ico/apple-touch-icon-114-precomposed.png') }}">
		<link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{ asset('packages/papajoker/bootstrap2/ico/apple-touch-icon-72-precomposed.png') }}">
		<link rel="apple-touch-icon-precomposed" href="{{ asset('packages/papajoker/bootstrap2/ico/apple-touch-icon-57-precomposed.png') }}">
	...
	<body>
		...
		<!-- Javascripts
		================================================== -->
		<script src="{{ asset('packages/papajoker/bootstrap2/js/jquery-1.10.1.min.js') }}"></script>
		<script src="{{ asset('packages/papajoker/bootstrap2/js/bootstrap-2.3.2.min.js') }}"></script>
	</body>
</html>
